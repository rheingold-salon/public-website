    ...
    const pages = [
        {
            ...
            route: "/dates-events",
            icon: Calendar,
            description: "Include new Events, including Podcasts, Talks and TV appearances."
        },
        {
            name: "news & publications",
            route: "/news-publications",
            icon: Newspaper,
            description: "Add new publications and classify them using the tags. Edit the home page slider."
        },
        {
            name: "references & cases",
            route: "/references-cases",
            icon: BookMarked,
            description: "Update customer groups and their icons as well as references and cases"
        },
        {
            name: "founders & team",
            route: "founders-team",

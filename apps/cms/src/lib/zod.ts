...
export const eventsSchema = object({
  id: number(), //.optional(),
  titleDe: string({ required_error: "German title is required" }).min(
    1,
    "German title is required",
  ),
  titleEn: string({ required_error: "English title is required" }).min(
    1,
    "English title is required",
  ),
  contentDe: string({ required_error: "German content is required" }).min(
    1,
    "German content is required",
  ),
  contentEn: string({ required_error: "English content is required" }).min(
    1,
    "English content is required",
  ),
  location: string({ required_error: "Location is required" }).min(
    1,
  ...
  time: string({ required_error: "Time is required" }).regex(
    /^([01]\d|2[0-3]):[0-5]\d(:[0-5]\d)?$/,
    "Time must be in HH:MM format",
  ),
  type: eventTypeEnum,
  imagePath: string({ required_error: "Image path is required" }).min(
    1,
    "Image path is required",
  ),
  externalLink: string({ required_error: "External link is required" }).min(
    1,
...
export const peopleSchema = object({
  ...
  roleDe: string({ required_error: "German role is required" }).min(
    1,
    "German role is required",
  ),
  roleEn: string({ required_error: "English role is required" }).min(
    1,
    "English role is required",
  ),
  quoteDe: string({ required_error: "German quote is required" }).min(
    1,
    "German quote is required",
  ),
  quoteEn: string({ required_error: "English quote is required" }).min(
    1,
    "English quote is required",
  ),
  aboutDe: string({ required_error: "German about is required" }).min(
    1,
    "German about is required",
  ),
  aboutEn: string({ required_error: "English about is required" }).min(
    1,
    "English about is required",
  ),
...
export const customergroupsSchema = object({
  id: number().optional(),
  nameDe: string({ required_error: "German name is required" }).min(
    1,
    "German name is required",
  ),
  nameEn: string({ required_error: "English name is required" }).min(
    1,
    "English name is required",
  ),
  imagesFolder: string({ required_error: "Images folder is required" }).min(
    1,
    "Images folder is required",
  ),
});
...
export const referencesSchema = object({
  ...
  positionDe: string({ required_error: "German position is required" }).min(
    1,
    "German position is required",
  ),
  positionEn: string({ required_error: "English position is required" }).min(
    1,
    "English position is required",
  ),
  imagePath: string({ required_error: "Image path is required" }).min(
    1,
    "Image path is required",
...
export const casesSchema = object({
  ...
  subtitleDe: string({ required_error: "German subtitle is required" }).min(
    1,
    "German subtitle is required",
  ),
  subtitleEn: string({ required_error: "English subtitle is required" }).min(
    1,
    "English subtitle is required",
  ),
  contentDe: string({ required_error: "German content is required" }).min(
    1,
    "German content is required",
...
export const createCustomergroupSchema = customergroupsSchema.omit({
  id: true,
});

...
export function GrayBox({ heading1, heading2, image, children }: { heading1: string, heading2: string, image?: StaticImageData, children: React.ReactNode }) {
    return (
        <div className="relative my-24">
            ...
            {image && <Image
                className="absolute bottom-0 left-0 h-1/2 w-32 md:w-64 max-h-96 rounded-tr-[100px]"
                src={image}
                alt="Grey Box Image"
                style={{
                    objectFit: "cover"
            ...
            <div className="pl-32 md:pl-64 pt-10">
                ...
                <div className="-ml-16 md:-ml-32">
                    <p className="font-semibold font-serif text-xl sm:text-2xl md:text-4xl">{heading1}</p>
                    <p className="font-semibold font-serif text-xl sm:text-2xl md:text-4xl text-salongreen">{heading2}</p>
                </div>

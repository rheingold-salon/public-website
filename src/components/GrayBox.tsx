export function GrayBox({ heading1, heading2, text }: { heading1: string, heading2: string, text: string }) {
    return (
        <div className="relative flex h-[35rem] md:h-72 my-24 items-end w-screen">
            <div className="bg-zinc-200 h-full w-1/6 md:w-1/4 z-[-1] text-right">
                ...
                <p className="absolute left-[10%] md:left-[18%] top-[17%] md:top-[25%] font-semibold font-serif text-4xl text-salongreen">{heading2}</p>
            </div>
